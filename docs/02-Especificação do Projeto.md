...
| 5 |  Tempo de ciclo do pedido | Avaliar o tempo total entre o momento que o cliente fez o pedido, até que o produto chegou até ele.  | Calcular o tempo entre o cliente fazer o pedido e o pedido chegar até ele.  |  | Aplicação    |    |
